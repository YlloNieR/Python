...
# bewegetes Label
lb = tkinter.Label(main, text="Test", relief="sunken", bd=1)
lb.place(relx=0, rely=0,anchor="nw")

# bewegt nach links
bleft = tkinter.Button(main, text="ganz links", command=movetoleft)
bleft.place(relx=0, rely=1, anchor="sw")

# bewegt nach rechts
bright = tkinter.Button(main, text="ganz rechts", command=movetoright)
