...
# Menü zur Fabreneinstellung
mpop = tkinter.Menu(main)
mpop["tearoff"] = 0
mpop.add_radiobutton(label="rot", variable=farbe, value="#FF0000", command=farbwechsel)
mpop.add_radiobutton(label="gelb", variable=farbe, value="#FFFF00", command=farbwechsel)
mpop.add_radiobutton(label="schwarz", variable=farbe, value="#000000", command=farbwechsel)
