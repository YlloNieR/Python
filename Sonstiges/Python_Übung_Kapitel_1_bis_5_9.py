...
class Time:
    pass
'''
def printTIME(times): #definiert Funktion mit Objekt
    print(str(times.hours),":",str(times.minutes),":",str(times.seconds)," Uhr")

currentTimes = Time()
currentTimes.hours = 9
currentTimes.minutes = 14
currentTimes.seconds = 30
...
class Point:
    def __init__(self, r=0, e=0):
        self.r = r
        self.e = e
    def __str__(self):
        return ( "(" + str(self.r) + "," + str(self.e) + ")")
