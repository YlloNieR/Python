...
fr1 = tkinter.Frame(main, width=200, height=150, relief="sunken", bd=1)
fr1.pack(side="top")

# Frame mit Schaltfläche zur Bewegung
...
# bewegt nach links
bleft = tkinter.Button(fr2, text="nach links", command=moveleft)
bleft.grid(row=1,column=0)

# bewegt nach rechts
bright = tkinter.Button(fr2, text="nach rechts", command=moveright)
...
# bewegt nach unten
bdown = tkinter.Button(fr2, text="nach unten", command=movedown)
bdown.grid(row=2,column=1)

# Startposition
bstart = tkinter.Button(fr2, text="Start", command=movestart)
