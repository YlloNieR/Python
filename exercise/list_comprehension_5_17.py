...
# liefere den Wert von item+1 für jedes einzelne Element in xliste
print(aliste)
print()
...
# Liefere den Wert von item+1 für jedes einzelne Element in xliste, aber nur, 
# wenn der Wert des einzelnen Elements größer als 7 ist
print(bliste)
print()

# Beipsiel 3: Version ohne List Comprehension
cliste = []
...
# Beipsiel 3: Version mit List Comprehension
