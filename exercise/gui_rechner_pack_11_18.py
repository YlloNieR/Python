...
frb.pack()
tkinter.Button(frb, text="1/x", width=7, command=kw).pack(side="left")
tkinter.Button(frb, text="x hoch 2", width=7, command=qu).pack(side="left")
tkinter.Button(frb, text="CL", width=7, command=cl).pack(side="left")
...
# Frame F mit Dezimlpunkt, Ziffer 0 und Ende
frf = tkinter.Frame(main)
frf.pack()
tkinter.Button(frf, text=".", width=7, command=anzp).pack(side="left")
tkinter.Button(frf, text="0", width=7,
               command=lambda: anz(0)).pack(side="left")
tkinter.Button(frf, text="Ende", width=7, command=ende).pack(side="left")
